 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_engcentral_subplugin extends restore_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/submission_engcentral');
    ...
    /**
     * Processes one assignsubmission_engcentral element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_engcentral_submission($data) {
        global $DB;
